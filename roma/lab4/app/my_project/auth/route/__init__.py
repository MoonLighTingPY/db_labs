...
def register_routes(app: Flask) -> None:
    ...
    from .orders.battery_producer_route import battery_producer_bp
    from .orders.battery_producer_log_route import battery_producer_log_bp
    ...
    app.register_blueprint(battery_producer_bp)
    app.register_blueprint(battery_producer_log_bp)
